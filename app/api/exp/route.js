...
export async function GET(req) {
  try {
    const categories = await prisma.exp.findMany();
...
export async function POST(req) {
  ...
  gua , 
    ...
    const category = await prisma.exp.create({ data: { 
        ex  ,
  pro ,
  gua , 
     } });
...
export async function PATCH(req) {
  ...
  gua , 
    ...
    const updatedCategory = await prisma.exp.update({
      where: { id },
      data: { 
          ex  ,
  pro ,
...
export async function DELETE(req) {
  try {
    ...
    const deletedCategory = await prisma.exp.delete({ where: { id } });
